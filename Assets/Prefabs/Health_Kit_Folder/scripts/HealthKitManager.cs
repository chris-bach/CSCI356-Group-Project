...
public class HealthKitManager : MonoBehaviour
{
    ...
    IEnumerator SpawnRoutine()
    {
        while (true)
        {
            ...
            {
                case 1:
                    posToSpawn = new Vector3(-52.5f, -4.45f, -29.5f); // Position 1 = (-20.5, -4.45, -29.5) 
                    if (newKit1 != null)
                    {
                        Destroy(newKit1);
                ...
                case 2:
                    posToSpawn = new Vector3(-53f, -4.45f, 29f); // Position 2 = (-21, -4.45, 29)
                    if (newKit2 != null)
                    {
                        Destroy(newKit2);
                ...
                case 3:
                    posToSpawn = new Vector3(-11.7f, -4.45f, 8.5f); // Position 3 = (21.7, -4.45, 8.5)
                    if (newKit3 != null)
                    {
                        Destroy(newKit3);
                ...
                case 4:
                    posToSpawn = new Vector3(-27f, -4.45f, -13f); // Position 4 = (5, -4.45, -13)
                    if (newKit4 != null)
                    {
                        Destroy(newKit4);
                ...
                case 5:
                    posToSpawn = new Vector3(-11.36f, -4.3f, -28.37f); // Position 5 = (21.36, -4.3, -28.37)
                    if (newKit5 != null)
                    {
                        Destroy(newKit5);
