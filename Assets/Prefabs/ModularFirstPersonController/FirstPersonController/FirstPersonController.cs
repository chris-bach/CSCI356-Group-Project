...
public class FirstPersonController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if(enableSprint)
        {
            ...
            {
                isZoomed = false;
                playerCam.fieldOfView = Mathf.Lerp(playerCam.fieldOfView, sprintFOV, sprintFOVStepTime * Time.deltaTime);
    ...
    {
        Vector3 origin = new Vector3(transform.position.x, transform.position.y + (transform.localScale.y * 0.05f), transform.position.z);
...
// Custom Editor
    ...
    public override void OnInspectorGUI()
    {
        ...
        fpc.playerCam = (Camera)EditorGUILayout.ObjectField(new GUIContent("Camera", "Camera attached to the controller."), fpc.playerCam, typeof(Camera), true);
